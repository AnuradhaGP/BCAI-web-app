...
const AiDashboard = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(HOST + "/api/monitoring/status")
  ...
  const toggleMonitoring = async () => {
    try {
      ...
      await axios.post(HOST + "/api/monitoring/toggle", { active: newState });
  ...
  return (
    <div className="w-full max-w-6xl mx-auto space-y-8 animate-fade-in-up">
      ...
      <header className="mb-10 text-center space-y-2">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 text-xs font-medium text-primary-400 mb-4">
          <Layers size={12} />
        ...
        <p className="text-gray-400 max-w-lg mx-auto">
          Monitor your CI/CD pipeline traffic in real-time. Detect anomalies and
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
          <div>
            ...
            <p className="text-xs text-gray-400 mt-1">
              Real-time packet inspection and continuous prediction.
            </p>
          </div>
          <button
        ...
        <div className="h-[250px] w-full bg-[#111218]/50 rounded-xl border border-white/5 p-4 flex items-center justify-center relative shadow-inner">
          {!isMonitoring && liveData.length === 0 ? (
            <div className="flex flex-col items-center text-gray-500 gap-3">
              ...
              <p className="text-sm">
                Live monitoring is currently turned off.
              </p>
            </div>
          ) : (
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <Line
                  ...
                  dataKey="prediction"
                  stroke={
                    liveData[liveData.length - 1]?.prediction === 1
                      ? "#ef4444"
                      : "#3b82f6"
                  }
                  strokeWidth={2}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
        <div className="w-full">
          <h3 className="text-lg font-medium text-white mb-4 px-1">
            Manual Packet Test
          </h3>
